        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center">
            ...
            <p className="text-lg text-gray-600 max-w-4xl mx-auto">
              Meet the team behind the sustainability intelligence platform transforming 
              the power sector&apos;s journey to net-zero by 2050.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-8 mb-8 shadow-sm">
          ...
          <div className="grid md:grid-cols-5 gap-6">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-green-600 font-medium mb-2">CEO & Co-Founder</p>
              <p className="text-sm text-gray-600">
                Former energy consultant with 15+ years in sustainability and regulatory compliance.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-blue-600 font-medium mb-2">CTO & Co-Founder</p>
              <p className="text-sm text-gray-600">
                Full-stack engineer specializing in real-time data systems and cloud architecture.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Dr. Elena Volkov</h3>
              <p className="text-sm text-purple-600 font-medium mb-2">Head of Data Science</p>
              <p className="text-sm text-gray-600">
                PhD in Environmental Engineering with expertise in carbon accounting and emissions modeling.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">James Thompson</h3>
              <p className="text-sm text-orange-600 font-medium mb-2">Head of Product</p>
              <p className="text-sm text-gray-600">
                Product strategist with deep experience in energy sector software and user experience design.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Aisha Patel</h3>
              <p className="text-sm text-teal-600 font-medium mb-2">Head of Business Development</p>
              <p className="text-sm text-gray-600">
                Business development expert with strong connections in the renewable energy and utility sectors.
              </p>
            </div>
          </div>
        </div>
