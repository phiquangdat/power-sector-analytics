                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Carbon emitted per unit electricity generated. This is the
                      core emissions intensity indicator for CSRD/ESRS climate
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed">
                    How current carbon intensity compares to this year's target
                    intensity.
                    <strong className="text-green-600">
                      100% = on target;
                    </strong>{" "}
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed">
                    ...
                    target?
                    <strong className="text-green-600">"On track"</strong> if
                    current decline rate is sufficient; otherwise "Behind".
                  </p>
                </div>
            ...
            <div className="group bg-white rounded-2xl border border-gray-200 p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:border-teal-300">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed">
                    Relation to the net-zero pathway and an illustrative ETA to
                    near-zero.
                    <strong className="text-green-600">
